...
function useIsMdUp() {
  ...
  useEffect(() => {
    ...
    const onChange = () => setIsMdUp(mediaQuery.matches);
    onChange();
  ...
  const formContent = (
    <>
      ...
      <div className="space-y-6">
        <div>
          <label className="text-[14px] font-semibold text-black">Title</label>
          <div className="mt-2">
            <Input
        ...
        <div>
          ...
          <div
            className={
              "mt-2 " + (isFullscreen ? "fixed inset-0 z-60 bg-white p-4" : "")
            }
          >
            <div className={wrapperClassName + (isFullscreen ? " h-full" : "")}>
              <div
                id={toolbarId}
              ...
              >
                <div className="relative">
                  <select
                    value={headingValue}
                    onChange={(e) => setHeading(e.target.value as HeadingValue)}
          ...
          <div className="mt-4 space-y-4">
            ...
            <div>
              ...
              {fieldErrors.tags ? (
                <p className="mt-1 text-xs text-rose-600">{fieldErrors.tags}</p>
              ) : null}
            </div>
